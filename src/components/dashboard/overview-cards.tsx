  ...
  return (
    <>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{formatCurrency(allTimeTotals.totalIncome)}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{formatCurrency(Math.abs(allTimeTotals.totalExpenses))}</div>
           <p className="text-xs text-muted-foreground">All time</p>
        </CardContent>
      </Card>
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{formatCurrency(Math.abs(allTimeTotals.totalInvestments))}</div>
          <p className="text-xs text-muted-foreground">All time</p>
        </CardContent>
      </Card>
    </>
